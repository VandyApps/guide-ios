...
- (void)drawRect:(CGRect)rect {
  ...
  if (displayedMessage == nil) {
    self.displayedMessage = NSLocalizedStringWithDefaultValue(@"OverlayView displayed message", nil, [NSBundle mainBundle], @"Scan Vanderbilt QR code.", @"Scan Vanderbilt QR code.");
  }
